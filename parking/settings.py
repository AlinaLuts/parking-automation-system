...
SECRET_KEY = 'django-insecure--pv7m^ovyp$r4@2jv&=%==1pw9nr0hx9@+=u3g@lf_=4vr0b4y'
...
MIDDLEWARE = [
    ...
    "parking.middleware.db_connection_middleware.RoleBasedDBConnectionMiddleware",
]
...
TIME_ZONE = 'Europe/Kiev'  # Убедитесь что это стоит
